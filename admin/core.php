...
if (basename($_SERVER['SCRIPT_NAME']) != 'game-settings.php' AND basename($_SERVER['SCRIPT_NAME']) != 'ads.php' AND basename($_SERVER['SCRIPT_NAME']) != 'custom-pages.php') {
...
<?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'ads.php' OR basename($_SERVER['SCRIPT_NAME']) == 'custom-pages.php') {
?>
	<!-- SummerNote-->
...
?>>
           <a href="ads.php">
              <i class="fas fa-bullhorn"></i>&nbsp; <span>Ads</span>
           </a>
        </li>
		
		<li <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'custom-pages.php') {
        echo 'class="active"';
    }
?>>
           <a href="custom-pages.php">
              <i class="fas fa-columns"></i>&nbsp; <span>Custom Pages</span>
           </a>
        </li>
...
?>>
		...
		<li <?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'tips.php') {
        echo 'class="active"';
    }
?>>
           <a href="tips.php">
...
<footer class="main-footer">
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://codecanyon.net/item/vcity-online-browser-game/21398810?ref=Antonov_WEB" target="_blank">vCity</a></strong>
