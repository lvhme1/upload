...
if (isset($_POST['add'])) {
    ...
    if ($validator > "0") {
        ...
        $query = mysqli_query($connect, "INSERT INTO `themes` (name, csspath, navbar_colorscheme, default_theme) VALUES('$name', '$csspath', '$navbar_cscheme', '$default')");
    }
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
		...
		<div class="callout callout-info">
            ...
            $query = mysqli_query($connect, "UPDATE `themes` SET name='$name', `csspath`='$csspath', `navbar_colorscheme`='$navbar_cscheme', `default_theme`='$default' WHERE id='$id'");
            echo '<meta http-equiv="refresh" content="0; url=themes.php">';
        }
    }
?>
...
?>" required>
								...
								<div class="form-group">
											<label class="col-sm-2 control-label">Navbar Color Scheme: </label>
											<div class="col-sm-10">
	<select name="cscheme" class="form-control" required>
        <option value="1" <?php
    if ($row['navbar_colorscheme'] == '1') {
        echo 'selected';
    }
?>>Dark</option>
        <option value="2" <?php
    if ($row['navbar_colorscheme'] == '2') {
        echo 'selected';
    }
?>>Primary</option>
		<option value="3" <?php
    if ($row['navbar_colorscheme'] == '3') {
        echo 'selected';
    }
?>>Light</option>
		<option value="4" <?php
    if ($row['navbar_colorscheme'] == '4') {
        echo 'selected';
    }
?>>Light 2</option>
    </select>
...
<form class="form-horizontal" action="" method="post">
				     <div class="box">
				        ...
				        <div class="box-body">
								...
								<div class="form-group">
											<label class="col-sm-4 control-label">Navbar Color Scheme: </label>
											<div class="col-sm-8">
	<select name="cscheme" class="form-control" required>
        <option value="1" selected>Dark</option>
        <option value="2">Primary</option>
		<option value="3">Light</option>
		<option value="4">Light 2</option>
    </select>
											</div>
								</div>
								<div class="form-group">
