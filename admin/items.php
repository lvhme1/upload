...
if (isset($_GET['delete-id'])) {
	...
	$query2 = mysqli_query($connect, "DELETE FROM `player_items` WHERE item_id='$id'");
}
?>
...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `items` (item, image, category_id, bonustype, bonusvalue, money, gold, respect, min_level, vip, active) VALUES ('$item', '$image', '$category_id', '$bonustype', '$bonusvalue', '$money', '$gold', '$respect', '$minlevel', '$vip', '$active')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `items` SET `item`='$item', `image`='$image', `category_id`='$category_id', `bonustype`='$bonustype', `bonusvalue`='$bonusvalue', `money`='$money', `gold`='$gold', `respect`='$respect', `min_level`='$minlevel', `vip`='$vip', `active`='$active' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=items.php">';
