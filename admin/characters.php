...
if (isset($_POST['add'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `characters` (name, image, description, category_id, power, agility, endurance, intelligence) VALUES('$name', '$image', '$description', '$category_id', '$power', '$agility', '$endurance', '$intelligence')");
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
        ...
        $query = mysqli_query($connect, "UPDATE `characters` SET name='$name', `image`='$image', `description`='$description', `category_id`='$category_id', `power`='$power', `agility`='$agility', `endurance`='$endurance', `intelligence`='$intelligence' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0; url=characters.php">';
