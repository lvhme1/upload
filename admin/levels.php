...
if (isset($_POST['add'])) {
    ...
    if ($validator > "0") {
        ...
        $query = mysqli_query($connect, "INSERT INTO `levels` (level, min_respect, description) VALUES('$level', '$minrespect', '$description')");
    }
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    if (isset($_POST['edit'])) {
		...
		<div class="callout callout-info">
            ...
            $query = mysqli_query($connect, "UPDATE `levels` SET level='$level', `min_respect`='$minrespect', `description`='$description' WHERE id='$id'");
            echo '<meta http-equiv="refresh" content="0; url=levels.php">';
        }
    }
?>
