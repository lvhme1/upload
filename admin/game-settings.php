...
if (isset($_POST['save'])) {
    ...
    $gcaptcha_sitekey   = addslashes(strip_tags($_POST['gcaptcha-sitekey']));
    $gcaptcha_secretkey = addslashes(strip_tags($_POST['gcaptcha-secretkey']));
    $tips_effect        = addslashes(strip_tags($_POST['tips-effect']));
    
    $content = addslashes(htmlentities($_POST['content']));
    
    $query = mysqli_query($connect, "UPDATE `settings` SET title='$title', description='$description', keywords='$keywords', startmoney='$start_money', startgold='$start_gold', paypal_email='$paypal_email', gcaptcha_sitekey='$gcaptcha_sitekey', gcaptcha_secretkey='$gcaptcha_secretkey', tips_effect='$tips_effect', about='$content' WHERE id=1");
...
?>">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">reCAPTCHA v2 Site Key:</label>
												<div class="col-md-8">
                                                    <div class="input-group">
                                                    <span class="input-group-addon"><i class="fas fa-key"></i></span>
													<input type="text" class="form-control" name="gcaptcha-sitekey" value="<?php
...
?>" required>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">reCAPTCHA v2 Secret Key:</label>
												<div class="col-md-8">
                                                    <div class="input-group">
                                                    <span class="input-group-addon"><i class="fas fa-key"></i></span>
													<input type="text" class="form-control" name="gcaptcha-secretkey" value="<?php
echo $row['gcaptcha_secretkey'];
?>" required>
                                                    </div>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Tips Effect:</label>
												<div class="col-md-8">
                                                    <div class="input-group">
                                                    <span class="input-group-addon"><i class="fas fa-magic"></i></span>
													<select name="tips-effect" class="form-control" required>
        <option value="1" <?php
