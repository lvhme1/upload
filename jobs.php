...
if (isset($_GET['finish-work'])) {
    ...
    if ($countjs > 0) {
        ...
        if ($correct == 'Yes' && time() >= $rowpjs['finishtime']) {
            ...
            $leave_work = mysqli_query($connect, "DELETE FROM `player_actions` WHERE type='$type' AND player_id='$player_id'");
            $get_salary = mysqli_query($connect, "UPDATE `players` SET money=money+'$money', gold=gold+'$gold', respect=respect+'250' WHERE id='$player_id'");
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">' . lang_key("wday-end") . '</h5>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <center>
                            <h4><span class="badge badge-info">' . lang_key("work-finish") . '</span></h4><br /><br /><br />
                            <div class="row">
                                <div class="col-md-6">
...
<div class="card"><div class="card-header text-white bg-primary">
        <h5 class="card-title"><i class="fa fa-briefcase"></i> <?php
echo lang_key("work");
?></h5>
    </div>
    <div class="card-body">
        <center><h4><i class="fa fa-list-ul"></i> <?php
echo lang_key("jobs");
?></h4></center><br />
...
?>
            <div class="col-md-6">
                <div class="jumbotron">
                    <center>
                        <h5><i class="fa fa-briefcase"></i> <?php
    echo $rowj['job_type'];
?></h5>
                        <hr />
                        <div class="row">
