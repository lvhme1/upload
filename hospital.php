...
if (isset($_GET['start-treatment'])) {
    ...
    if ($countht > 0) {
        ...
        if ($rowu['health'] < 100 && $rowu['money'] >= $cost && $busy == 'No') {
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">' . lang_key("end-treatment") . '</h5>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <center>
                            <h4><span class="badge badge-info"><i class="fa fa-user-md"></i> ' . lang_key("finished-treatment") . '</span></h4><br /><br /><br />
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <h5><i class="fa fa-heartbeat"></i>  Health: <br /><hr /><span class="badge badge-secondary">+ ' . $health_restore . '</span></h5>
                                </div>
                                <div class="col-md-4"></div>
                            </div><br /><br />
...
<div class="col-md-12 card bg-light card-body">
    ...
    <center><h4><i class="fa fa-hospital"></i> <?php
...
<?php
    ...
    } else if ($rowu['health'] == 100 || $rowu['money'] < $rowh['cost'] || $countpac > 0) {
