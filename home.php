...
if (isset($_GET['sell-id'])) {
    ...
    if ($countsvv > 0) {
        ...
        $respect_back = $rowvfsc['respect'] / 2;
        
        $sell_vehicle = mysqli_query($connect, "DELETE FROM `player_vehicles` WHERE vehicle_id='$vehiclefs_id' AND player_id='$player_id'");
        
        $values_back = mysqli_query($connect, "UPDATE `players` SET money=money+'$money_back', respect=respect-'$respect_back' WHERE id='$player_id'");
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">' . lang_key("selling-vehicle") . '</h5> 
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <center>
                            <h5><span class="badge badge-info">' . lang_key("success-soldv") . '</span></h5>
                                <img src="' . $rowvfsc['image'] . '" width="75%"><br />
                            <br /><br />
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="images/icons/money.png" width="25%"><br />
                                    <h5>Money: <br /><hr /><span class="badge badge-secondary">+ ' . $money_back . '</span></h5>
                                </div>
                                <div class="col-md-6">
                                    <img src="images/icons/gold1.png" width="25%"><br />
                                    <h5>Gold: <br /><hr /><span class="badge badge-secondary">+ ' . $gold_back . '</span></h5>
                                </div>
                            </div><br /><br />
...
if ($rowu['timeonline'] > $timeonline) {
    echo '<span class="badge badge-success"><i class="fa fa-circle"></i> ' . lang_key("online") . '</span>';
}
?>
</font></h5>
                                    <hr />
...
';
    ...
    echo '<div class="alert alert-info mx-auto"><i class="fa fa-info-circle"></i> ' . lang_key("yno-items") . '</div>
...
?></a></strong>
        ...
        echo $rowcp['id'];
?>" class="btn btn-danger btn-sm float-right" title="<?php
                ...
                <div class="col-md-8">
                    <div class="card"><div class="card-header text-white bg-primary">
                            <div class="btn-group btn-group-xs float-right">
                                <a href="home-upgrades.php" class="btn btn-sm btn-success"><em class="fa fa-fw fa-arrow-circle-up"></em><span class="hidden-xs"><?php
...
?>
                    <div class="card"><div class="card-header text-white bg-primary">
                            <div class="btn-group btn-group-xs float-right">
                                <a href="garage-upgrades.php" class="btn btn-sm btn-success"><em class="fa fa-fw fa-arrow-circle-up"></em><span class="hidden-xs"><?php
...
?>" class="btn btn-danger float-right"><em class="fa fa-fw fa-dollar-sign"></em><span class="hidden-xs"><?php
            echo lang_key("sell");
?></span></a>
                                    </div>
                                </div>
...
<?php
    ...
    echo '<div class="alert alert-success"><center><a href="garage-upgrades.php" class="btn btn-success btn-md btn-block" style="text-decoration: none;"><i class="fa fa-car"></i>&nbsp;&nbsp;' . lang_key("buy-garage") . '</a></center></div><br />';
}
?>
...
?>
                    <div class="card"><div class="card-header text-white bg-primary">
                            <div class="btn-group btn-group-xs float-right">
                                <a href="hangar-upgrades.php" class="btn btn-sm btn-success"><em class="fa fa-fw fa-arrow-circle-up"></em><span class="hidden-xs"><?php
...
?>); background-size: 100% 100%; background-repeat: no-repeat; height: 500px;">
                                        <center><img src="<?php
            echo $rowhvc['image'];
?>" width="90%" style="position: absolute; left: 7%; bottom: 18%;" /></center>
                                    </div>
                                    <div class="card-footer">
                                        <a href="vehicle-upgrades.php#<?php
            echo $rowphv['id'];
...
?></strong></div>
        <br /><br /><br /><br /><br /><br /><center><a href="vehicles.php" class="btn btn-primary btn-md"><i class="fa fa-plane"></i>&nbsp;&nbsp;<?php
        echo lang_key("buy-plane");
?></a></center>
    </div>
<?php
    }
...
<?php
    ...
    echo '<div class="alert alert-info"><center><a href="hangar-upgrades.php" class="btn btn-info btn-block" style="text-decoration: none;"><i class="fa fa-plane"></i>&nbsp;&nbsp;' . lang_key("buy-hangar") . '</a></center></div><br />';
}
?>
...
?>
                    <div class="card"><div class="card-header text-white bg-primary">
                            <div class="btn-group btn-group-xs float-right">
                                <a href="quay-upgrades.php" class="btn btn-sm btn-success"><em class="fa fa-fw fa-arrow-circle-up"></em><span class="hidden-xs"><?php
...
<?php
    ...
    echo '<div class="alert alert-warning"><center><a href="quay-upgrades.php" class="btn btn-warning btn-md btn-block" style="text-decoration: none;"><i class="fa fa-ship"></i>&nbsp;&nbsp;' . lang_key("buy-quay") . '</a></center></div>';
}
?>
