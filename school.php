            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">' . lang_key("end-education") . '</h5>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <center>
                            <h4><span class="badge badge-info">' . lang_key("finish-edu") . '</span></h4><br /><br /><br />
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <h5><i class="fa fa-graduation-cap"></i>  Intelligence: <br /><hr /><span class="badge badge-secondary">+ ' . $intelligence . '</span></h5>
                                </div>
                                <div class="col-md-4"></div>
                            </div><br /><br />
...
<div class="card"><div class="card-header text-white bg-primary">
        <h5 class="card-title"><i class="fa fa-graduation-cap"></i> <?php
echo lang_key("school");
?></h5>
    </div>
    <div class="card-body">
        
        <center><h4><i class="fa fa-graduation-cap"></i> <?php
echo lang_key("school");
?></h4></center><br />
...
?><span class="badge badge-success float-right"><i class="fa fa-dollar-sign"></i> <?php
    echo $rowsc['fee'];
?></span>
                    </li>
                    <li class="list-group-item">
...
?> / 250</span>
                    </div><div class="progress-bar bg-success" style="width: <?php
