            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fa fa-envelope"></i> ' . lang_key("message") . '</h5>
                    ...
                    <div class="modal-body">
                        <center>
						    <div class="well">
							    <form>
 							        <label for="rg-from" style="width: 100%"><i class="fa fa-user"></i> ' . lang_key("sender") . ': </span>&nbsp;
  							        <div class="form-group">
 							            <input type="text" id="rg-from" name="rg-from" value="' . $rowvs['username'] . '" class="form-control" disabled>
 							        </div>
									<br />
									<label for="rg-fromd" style="width: 100%"><i class="far fa-calendar-alt"></i> ' . lang_key("date") . ': </span>&nbsp;
  							        <div class="form-group">
 							            <input type="text" id="rg-fromd" name="rg-from" value="' . $rowvpm['date'] . ' ' . lang_key("at") . ' ' . $rowvpm['time'] . '" class="form-control" disabled>
 							        </div>
									<br />
									<label style="width: 100%"><i class="far fa-file-alt"></i> ' . lang_key("message") . ': </span><br />
 							            <textarea class="form-control" id="content" name="content" rows="6" style="min-width: 100%" disabled>' . $rowvpm['content'] . '</textarea>
							    </form>
							</div>
    ...
    echo '
        ...
        <div id="sent" class="modal fade">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fa fa-envelope"></i> ' . lang_key("sending-message") . '</h5>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <center>
                            <h4><span class="badge badge-success"><i class="far fa-paper-plane"></i>&nbsp; ' . lang_key("success-sent") . '</span></h5><br /><br />
...
<div class="col-md-12 card bg-light card-body">
    ...
    <center><h4><i class="fa fa-envelope"></i> <?php
...
?></h4><br />
	...
	<div class="col-md-10">
        <ul class="nav nav-tabs nav-justified">
          <li class="nav-item active"><a class="nav-link active" data-toggle="tab" href="#home"><i class="far fa-envelope"></i>&nbsp; <?php
echo lang_key("inbox");
?></a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu1"><i class="far fa-paper-plane"></i>&nbsp; <?php
...
<?php
    ...
    if ($rowpms['role'] == "Admin") {
        echo '<span class="badge badge-danger"><i class="fa fa-bookmark"></i> ' . $rowpms['role'] . '</span> ';
    }
    if ($rowpms['role'] == "VIP") {
        echo '<span class="badge badge-warning"><i class="fa fa-star"></i> ' . $rowpms['role'] . '</span> ';
    }
?>
</td>
...
?>
          ...
          <div id="menu1" class="tab-pane fade">
			    ...
			    <form action="" method="post">
			      <div class="form-group">
 			       <label for="toid" style="width: 100%;"><i class="fa fa-user"></i> <?php
...
?>
				 ...
				 <div class="form-group">
 				    <label for="content" style="width: 100%;"><i class="far fa-file-text"></i> <?php
echo lang_key("message");
?></span>
 				    <textarea class="form-control" id="content" name="content" rows="4" required></textarea>
 				  </div>
 			     <button type="submit" name="sendm" class="btn btn-primary btn-block"><i class="fa fa-paper-plane"></i> <?php
echo lang_key("send");
?></button>
			    </form>
